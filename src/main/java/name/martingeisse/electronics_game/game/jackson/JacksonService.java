package name.martingeisse.electronics_game.game.jackson;
...
import name.martingeisse.electronics_game.platform.util.attribute.AttributeKey;
import name.martingeisse.electronics_game.platform.util.attribute.Attributes;
