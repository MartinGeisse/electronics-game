...
/**
 * Used by game logic classes to send change events. This class does not preserve the order of events -- if the order
 * is important to a listener, it must be restored by that listener (e.g. using sequence numbers).
 */
@Singleton
