package name.martingeisse.electronics_game.gui.homepage;

import name.martingeisse.electronics_game.game.player.Player;
import name.martingeisse.electronics_game.game.player.PlayerLoginRepository;
import name.martingeisse.electronics_game.gui.gamepage.GamePage;
