package name.martingeisse.electronics_game.gui.gamepage;

import name.martingeisse.electronics_game.gui.websockets.GameListenerWebSocketBehavior;
import name.martingeisse.electronics_game.platform.wicket.LoginCookieUtil;
import name.martingeisse.electronics_game.platform.wicket.MyWicketSession;
import name.martingeisse.electronics_game.platform.wicket.page.AbstractPage;
	...
	public GamePage(PageParameters pageParameters) {
		...
		add(new AbstractDefaultAjaxBehavior() {
			...
			public void renderHead(Component component, IHeaderResponse response) {
				...
				builder.append("if (!window.name.startsWith('electronics-game-')) {\n");
				builder.append("	window.name = 'electronics-game-' + Math.random();\n");
				builder.append("}\n");
