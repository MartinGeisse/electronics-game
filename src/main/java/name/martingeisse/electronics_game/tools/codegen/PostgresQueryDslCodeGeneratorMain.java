package name.martingeisse.electronics_game.tools.codegen;

import com.querydsl.sql.codegen.DefaultNamingStrategy;
import com.querydsl.sql.codegen.MetaDataExporter;
import name.martingeisse.electronics_game.platform.postgres.MyPostgresConfiguration;
...
public class PostgresQueryDslCodeGeneratorMain {
	...
	public static void main(String[] args) throws Exception {
		...
		source.setDatabaseName("electronics_game");
		...
		try (Connection connection = source.getConnection()) {
			...
			exporter.setPackageName("name.martingeisse.electronics_game.postgres_entities");
