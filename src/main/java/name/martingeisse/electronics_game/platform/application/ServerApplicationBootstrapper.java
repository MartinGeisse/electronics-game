...
import name.martingeisse.electronics_game.platform.util.logging.JulToLog4jBridge;
import name.martingeisse.electronics_game.platform.util.logging.MyLayout;
