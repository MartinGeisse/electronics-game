 ...
 */
package name.martingeisse.electronics_game.platform.util.logging;
 ...
 * does not start with name.martingeisse.electronics_game) are suppressed if they are below that log level.
...
//		}
		...
		// regular case
		return !loggerName.startsWith("name.martingeisse.electronics_game");
