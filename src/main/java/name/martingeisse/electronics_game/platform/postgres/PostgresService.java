package name.martingeisse.electronics_game.platform.postgres;

import com.google.inject.Inject;
import com.google.inject.Singleton;
import name.martingeisse.electronics_game.common.database.DatabaseService;
import name.martingeisse.electronics_game.common.util.UnexpectedExceptionException;
import name.martingeisse.electronics_game.platform.application.configuration.annotated.AnnotatedConfigurationParticipant;
import name.martingeisse.electronics_game.platform.application.configuration.annotated.ConfigurationSetting;
...
public class PostgresService implements DatabaseService, AnnotatedConfigurationParticipant {
	...
	public PostgresService() {
		...
		dataSource.setDataSourceName("PostgreSQL Database");
