...
public class CachedPlayerAttributeRow implements Serializable {
	 ...
	 * the key
	 */
	private name.martingeisse.electronics_game.game.player.PlayerAttributeKey key;
	/**
	 * the playerId
	 */
	 ...
	 * @return the key
	 */
	public name.martingeisse.electronics_game.game.player.PlayerAttributeKey getKey() {
		return key;
	}
	 ...
	 */
	public void setKey(name.martingeisse.electronics_game.game.player.PlayerAttributeKey key) {
		this.key = key;
	}
