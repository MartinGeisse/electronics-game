...
public class PlayerShipEquipmentSlotRow implements Serializable {
	 ...
	 * the slotType
	 */
	private name.martingeisse.electronics_game.game.equipment.PlayerShipEquipmentSlotType slotType;
	/**
	 ...
	 * @return the slotType
	 */
	public name.martingeisse.electronics_game.game.equipment.PlayerShipEquipmentSlotType getSlotType() {
		return slotType;
	}
	 ...
	 */
	public void setSlotType(name.martingeisse.electronics_game.game.equipment.PlayerShipEquipmentSlotType slotType) {
