...
public class QCachedPlayerAttributeRow extends com.querydsl.sql.RelationalPathBase<CachedPlayerAttributeRow> {
	...
	public final EnumPath<name.martingeisse.electronics_game.game.player.PlayerAttributeKey> key = createEnum("key", name.martingeisse.electronics_game.game.player.PlayerAttributeKey.class);
