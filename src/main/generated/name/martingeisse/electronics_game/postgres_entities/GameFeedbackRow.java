...
public class GameFeedbackRow implements Serializable {
	 ...
	 * the context
	 */
	private name.martingeisse.electronics_game.tools.codegen.PostgresJsonb context;
	/**
	 * the id
	 */
	private Long id;
	 ...
	 * @return the context
	 */
	public name.martingeisse.electronics_game.tools.codegen.PostgresJsonb getContext() {
		return context;
	}
	 ...
	 */
	public void setContext(name.martingeisse.electronics_game.tools.codegen.PostgresJsonb context) {
