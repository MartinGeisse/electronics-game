...
public class MarketOrderRow implements Serializable {
	 ...
	 * the type
	 */
	private name.martingeisse.electronics_game.game.market.MarketOrderType type;
	/**
	 * the unitPrice
	 */
	 ...
	 * @return the type
	 */
	public name.martingeisse.electronics_game.game.market.MarketOrderType getType() {
		return type;
	}
	 ...
	 */
	public void setType(name.martingeisse.electronics_game.game.market.MarketOrderType type) {
		this.type = type;
	}
