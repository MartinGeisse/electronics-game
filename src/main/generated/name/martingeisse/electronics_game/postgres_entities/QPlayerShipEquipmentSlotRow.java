...
public class QPlayerShipEquipmentSlotRow extends com.querydsl.sql.RelationalPathBase<PlayerShipEquipmentSlotRow> {
	...
	public final EnumPath<name.martingeisse.electronics_game.game.equipment.PlayerShipEquipmentSlotType> slotType = createEnum("slotType", name.martingeisse.electronics_game.game.equipment.PlayerShipEquipmentSlotType.class);
