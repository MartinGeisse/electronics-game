...
public class ActionQueueSlotRow implements Serializable {
	 ...
	 * the action
	 */
	private name.martingeisse.electronics_game.tools.codegen.PostgresJsonb action;
	/**
	 * the actionQueueId
	 */
	 ...
	 * @return the action
	 */
	public name.martingeisse.electronics_game.tools.codegen.PostgresJsonb getAction() {
		return action;
	}
	 ...
	 */
	public void setAction(name.martingeisse.electronics_game.tools.codegen.PostgresJsonb action) {
		this.action = action;
	}
