...
public class QMarketOrderRow extends com.querydsl.sql.RelationalPathBase<MarketOrderRow> {
	...
	public final EnumPath<name.martingeisse.electronics_game.game.market.MarketOrderType> type = createEnum("type", name.martingeisse.electronics_game.game.market.MarketOrderType.class);
