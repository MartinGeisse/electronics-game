...
public class SpaceObjectBaseDataRow implements Serializable {
	 ...
	 * the type
	 */
	private name.martingeisse.electronics_game.game.space.SpaceObjectType type;
	 ...
	 * @return the type
	 */
	public name.martingeisse.electronics_game.game.space.SpaceObjectType getType() {
		return type;
	}
	 ...
	 */
	public void setType(name.martingeisse.electronics_game.game.space.SpaceObjectType type) {
		this.type = type;
	}
