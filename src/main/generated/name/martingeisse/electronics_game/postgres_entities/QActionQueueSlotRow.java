...
public class QActionQueueSlotRow extends com.querydsl.sql.RelationalPathBase<ActionQueueSlotRow> {
	...
	public final SimplePath<name.martingeisse.electronics_game.tools.codegen.PostgresJsonb> action = createSimple("action", name.martingeisse.electronics_game.tools.codegen.PostgresJsonb.class);
