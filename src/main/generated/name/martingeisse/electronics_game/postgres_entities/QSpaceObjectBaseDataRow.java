...
public class QSpaceObjectBaseDataRow extends com.querydsl.sql.RelationalPathBase<SpaceObjectBaseDataRow> {
	...
	public final EnumPath<name.martingeisse.electronics_game.game.space.SpaceObjectType> type = createEnum("type", name.martingeisse.electronics_game.game.space.SpaceObjectType.class);
